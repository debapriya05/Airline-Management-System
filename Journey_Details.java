...
public class Journey_Details extends JFrame{  //Forth
	...
	String[] items1 =  {"Mumbai", "Kolkata", "Bangalore", "Tokyo", "San Andreas", "Delhi","Australia","Saudi Arabia"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"Coimbatore", "Hyderabad", "Wasington", "Delhi","Australia","Saudi Arabia"};
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    if(rs.next()){rs.beforeFirst(); // Reset the cursor position to the beginning
